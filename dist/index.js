...
async function loadActionModules() {
    ...
    const coreModule = await Promise.all(/* import() */[__nccwpck_require__.e(119), __nccwpck_require__.e(421)]).then(__nccwpck_require__.bind(__nccwpck_require__, 6421));
    const githubModule = await Promise.all(/* import() */[__nccwpck_require__.e(119), __nccwpck_require__.e(536), __nccwpck_require__.e(351)]).then(__nccwpck_require__.bind(__nccwpck_require__, 1351));
    const utilsModule = await Promise.all(/* import() */[__nccwpck_require__.e(119), __nccwpck_require__.e(536)]).then(__nccwpck_require__.bind(__nccwpck_require__, 6536));
    core = coreModule;
    github = githubModule;
...
async function wait_for_upload(client, nwo, sarif_id) {
    for (let i = 0; i < 10; i++) {
        if (i > 0) {
...
async function run() {
    ...
    const client = new retryingOctokit(getOctokitOptions(api_token, {
        baseUrl: apiURL,
...
var import_core = __nccwpck_require__(2162);
